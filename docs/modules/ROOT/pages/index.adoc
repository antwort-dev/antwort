...
* xref:extensions:index.adoc[Extensions] explains how to implement custom providers, tool executors, authenticators, and storage backends.
* xref:operations:index.adoc[Operations] covers production deployment, monitoring, and troubleshooting.
